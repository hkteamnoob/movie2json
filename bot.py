...
TELEGRAM_BOT_TOKEN = environ.get('BOT_TOKEN', "")
API_ID = int(environ.get('API_ID', ''))  # Replace with your API ID from my.telegram.org
API_HASH = environ.get('API_HASH', "")  # Replace with your API Hash from my.telegram.org
